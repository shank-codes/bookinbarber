...
<html lang="en">
    ...
    <div class="container">
        ...
        <form name="login_form"  action="validateAdminLogin.php" method="POST">
            <label for="uemail">Shop Id  </label> <br>
            <input type="number" name="username" id="uemail" 
            required placeholder="Enter shop id">
            <br>
